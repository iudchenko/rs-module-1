...
const Main = () => {
  ...
  const pwc1 = useTypedSelector(
    (state) => state.unhandled.passwordConfirmation
  );
  ...
  const pwc2 = useTypedSelector((state) => state.hook.passwordConfirmation);
    ...
    <main className="prose text-white ">
      <div className="flex">
        <div className="p-5">
          ...
          <p>Gender: {gender1 === Gender.DEFAULT ? '' : gender1}</p>
          <p>Terms: {accept1 ? 'accepted' : ''}</p>
          <p>Picture:</p>
          {picture1 && <img src={picture1} className="max-w-xs" />}
          <p>Country: {country1 === Country.DEFAULT ? '' : country1}</p>
        </div>
        <div className="p-5">
          ...
          <p>Gender: {gender2 === Gender.DEFAULT ? '' : gender2}</p>
          <p>Terms: {accept2 ? 'accepted' : ''}</p>
          <p>Picture:</p>
          {picture2 && <img src={picture2} className="max-w-xs" />}
          <p>Country: {country2 === Country.DEFAULT ? '' : country2}</p>
        </div>
      </div>
    </main>
  );
